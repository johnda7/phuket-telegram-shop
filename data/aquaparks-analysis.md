...
**Всего мест:** ~5-7 (небольшая категория - ИДЕАЛЬНО для практики!)

### Основные аквапарки (по приоритету):

1. **Andamanda Phuket** ⭐⭐⭐⭐⭐
   - Самый новый и современный
   - Тайская мифология
   - Рейтинг: 4.7
   - Район: Kathu
   - Must-See: Горка "Naga Racer"
...
3. **Blue Tree Phuket** ⭐⭐⭐⭐
   ...
   - Рейтинг: 4.4
   - Район: Cherngtalay
   - Must-See: Детская зона

4. **Patong Beach Waterpark** (если существует)
   - В центре Патонга
   - Компактный
   - Рейтинг: 4.2
   - Район: Patong

5. **Аквапарки при отелях** (daypass доступны):
   - Centara Grand Beach Resort
   - Novotel Phuket Karon Beach Resort
...
### Районы (district:):
```
district:Kathu          → Andamanda
district:Thalang        → Splash Jungle
district:Cherngtalay    → Blue Tree
district:Patong         → Если есть местные
```

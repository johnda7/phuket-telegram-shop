// Финально создаем недостающие фотографии Robinson Lifestyle Phuket
...
async function finalizeRobinsonPhotos() {
  console.log('📥 ФИНАЛЬНО СОЗДАЕМ НЕДОСТАЮЩИЕ ФОТОГРАФИИ ROBINSON LIFESTYLE PHUKET\n');
...
finalizeRobinsonPhotos().catch(console.error);

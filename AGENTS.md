...
.shopify/CATEGORY_MIGRATION_GUIDE.md   ← 🔥 ПОЛНЫЙ ГАЙД ПО ПЕРЕНОСУ КАТЕГОРИЙ!
...
**🎯 ВАЖНО ДЛЯ ПЕРЕНОСА КАТЕГОРИЙ:**
Если нужно перенести категорию с phuket-insider.com:
1. Читай `.shopify/CATEGORY_MIGRATION_GUIDE.md` ПОЛНОСТЬЮ!
2. Используй эталон: категория "Shopping" (торговые центры)
3. Следуй ТОЧНО шаблонам из гайда
4. Проверяй результат на каждом этапе

**🤖 ВАЖНО ДЛЯ АВТОМАТИЗАЦИИ:**
Если нужно обработать много мест автоматически:
1. Читай `.shopify/AUTO_PHOTO_PARSING_GUIDE.md` ПОЛНОСТЬЮ!
2. Настрой Google Custom Search API
3. Используй готовые скрипты из гайда
4. Проверяй результат на каждом этапе

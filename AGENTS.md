...
**🎯 ВАЖНО ДЛЯ ЗАПОЛНЕНИЯ КАТЕГОРИЙ:**
Если нужно заполнить новую категорию (пляжи, храмы, рестораны):
1. Читай `.shopify/README.md` ПЕРВЫМ - главный индекс всех руководств!
2. Читай `.shopify/CATEGORY_FILLING_GUIDE.md` ПОЛНОСТЬЮ - пошаговое руководство!
3. Используй эталон: категория "Shopping" (торговые центры) - полностью готова!
4. Следуй ТОЧНО шаблонам из гайдов
5. Проверяй результат на каждом этапе
